...
Below, I outline my research in 3 strands: [AI4Networks](#ai4networks), [Networks4AI](#networks4ai), [Sociodigital Futures of Networks](#sociodigital-futures-of-networks).
...
Future Directions:
<br>
<p>Adaptive trust models that learn from contextual signals and user feedback to maintain security posture without compromising usability?
Rather than replacing human operators, how might AI augment human decision-making in complex security scenarios?</p>
</div> 
...
<a id="sociodigital-futures-of-networks"></a>
